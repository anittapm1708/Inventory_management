...
app.get("/submitForm", (req, res) => {
  res.sendFile(path.join(__dirname, "/templates/insert1.html"));
});

app.get("/deleteForm", (req, res) => {
  res.sendFile(path.join(__dirname, "/templates/delete1.html"));
});
...
app.get("/searchForm", (req, res) => {
  res.sendFile(path.join(__dirname, "/templates/search1.html"));
});
  ...
  try {
    ...
    const query = `
            ...
            SET
                ...
                BACKUP_LOCATION_POLICY_OR_NFS_SHARED_LOCA = :BACKUP_LOCATION_POLICY_OR_NFS_SHARED_LOCA,
    ...
    const binds = {
      ...
      BACKUP_LOCATION_POLICY_OR_NFS_SHARED_LOCA:
        data.BACKUP_LOCATION_POLICY_OR_NFS_SHARED_LOCA,
